...
/// Поддерживает кооперативную отмену через CancellationToken (проверка раз в эпоху).
/// </summary>
public sealed class Trainer
{
    ...
    public float Fit(
        ...
        Fit(trainX, trainY, ReadOnlySpan<float>.Empty, ReadOnlySpan<float>.Empty, epochs, batchSize, seed, cancellationToken);
